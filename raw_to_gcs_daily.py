...
if __name__=="__main__":
    ...
    for hour in range(0,24):
        for minute in [0,15,30,45]:
            try:
                collect_to_gcs(yesterday, hour, minute)
                ...
                with open('no_data.txt', 'a') as f:
                    f.write(f"No data for:{yesterday.year}_{yesterday.month:02d}_{yesterday.day:02d}_{hour:02d}_{minute:02d}")
                    f.write("\n")
                continue
            ...
            #This except catches that.
                with open('no_data.txt', 'a') as f:
                    f.write(f"No data in file for:{yesterday.year}_{yesterday.month:02d}_{yesterday.day:02d}_{hour:02d}_{minute:02d}")
                    f.write("\n")
                continue
